...
${EL_JAVA}/commons-lang-2.3.jar:\
${EL_JAVA}/commons-lang3-3.2.1.jar:\
${EL_JAVA}/commons-logging-1.1.jar:\
${EL_JAVA}/guava-20.0.jar:\
${EL_JAVA}/guice-4.0-no_aop.jar:\
${EL_JAVA}/httpclient-4.5.jar:\
${EL_JAVA}/httpcore-4.4.1.jar:\
${EL_JAVA}/jackson-annotations-2.9.4.jar:\
${EL_JAVA}/jackson-core-2.9.4.jar:\
${EL_JAVA}/jackson-databind-2.9.4.jar:\
${EL_JAVA}/jackson-dataformat-yaml-2.9.4.jar:\
${EL_JAVA}/jackson-datatype-joda-2.9.4.jar:\
${EL_JAVA}/jackson-dataformat-yaml-2.9.3.jar:\
...
${EL_JAVA}/swagger-annotations-1.5.18.jar:\
${EL_JAVA}/swagger-core-1.5.18.jar:\
${EL_JAVA}/swagger-models-1.5.18.jar:\
${EL_JAVA}/swagger-parser-1.0.34.jar:\
